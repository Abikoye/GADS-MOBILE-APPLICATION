...
import com.dev.gadsproject.adapters.SkillIqLeaderAdapter;
...
public class SkillIqLeadersFragment extends Fragment {
    ...
    private void initAdapter(){
        adapter= new SkillIqLeaderAdapter(getContext());
        LinearLayoutManager mLayoutManager = new LinearLayoutManager(getContext());
        recyclerView.setLayoutManager(mLayoutManager);
        recyclerView.setAdapter(adapter);
    }

    private void fetchSkillLearner(){
        GADSService service = GADSClient.getRetrofit().create(GADSService.class);
        service.fetchSkillIqList()
